...
public class RetraceTest {
	...
	public void retrace() throws IOException {
		...
		assertEquals("java.lang.RuntimeException: some text\n" +
						...
						"\t\t\t\taccess$200$7a4c6e58\n" +
						"\tat com.github.artyomcool.retrace.StackTraceAnalyzer$1.apply(SourceFile:62)\n" +
						"\tat com.github.artyomcool.retrace.StackTraceAnalyzer.resolveClassName(SourceFile:105)\n" +
						"Caused by: java.lang.IllegalArgumentException: some text 2\n" +
						"\tat com.github.artyomcool.retrace.Retrace.stacktrace(SourceFile:40)\n" +
						"\tat some.unknown.method(SourceFile:76)\n" +
						"\tat some.unknown.method2(UnknownSource)\n" +
						"\tat com.github.artyomcool.retrace.ClassMapping.getObfuscatedName(UnknownSource)\n" +
						"\t\t\t\taddLine\n" +
						"Caused by: java.lang.NullPointerException\n" +
						"\tat com.github.artyomcool.retrace.MethodMapping.toString(SourceFile:45)\n" +
						"\t... 2 more\n",
				retraced);
	}
